""" given an array find the sub-array with a sum
that is the maximum of subarray values
 """
# clarification
# sub array - continue section of array
# find the subarray that would give the maxium sum

# if the array contains all positive values the whole
# array is the maximum value

# if the array contains all negative values the 
# greatest negative value is the msa


# this implementation allows zero-length subarrays to be returned
# 0(n) Kandane's Algorithm
def brute_force(lst):
    """ scan throug the entire list
